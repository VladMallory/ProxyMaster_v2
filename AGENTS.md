...
3. **Режим планирования и режим build**
   ...
   - Так не делай вопросы для уточнения по нескольку раз на одну и ту же тему.
...
5. **Стиль кода**
   ...
   - Ты обязан делать комментарии в коде. Что это за функция.
   - Ты обязан делать комментарии в коде внутри функций что за что отвечат. Обьяснить почему мы делаем так и зачем мы это используем
