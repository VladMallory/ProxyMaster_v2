...
// GetNextDeviceAddonChargeAt возвращает дату ближайшего списания для доп. устройств пользователя.
...
// PrepayDeviceAddonsAtomic атомарно предоплачивает доп. устройства пользователя.
// Возвращает количество предоплаченных устройств.
...
// ProcessDueDeviceAddonsBilling обрабатывает биллинг подлежащих к списанию доп. устройств.
// Возвращает список пользователей, у которых недостаточно средств.
